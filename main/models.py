...
class AboutCTA(models.Model):
    title = models.CharField(max_length=200, default="Ready to Experience Authentic AARI Embroidery?")
    subtitle = models.TextField(default="Join us in celebrating traditional craftsmanship...")
    primary_button_text = models.CharField(max_length=50, default="Explore Collections")
    primary_button_url = models.CharField(max_length=100, default="/collections/")
    secondary_button_text = models.CharField(max_length=50, default="Contact Us")
    secondary_button_url = models.CharField(max_length=100, default="/contact/")
    is_active = models.BooleanField(default=True)
